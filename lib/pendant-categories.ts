...
export const PENDANT_CATEGORIES: Record<CategoryId, PendantCategory> = {
  face: {
    id: 'face',
    label: 'Face Pendant',
    description: 'A close, single-face crop — the catalogue\'s tightest framing.',
  ...
  'half-size': {
    ...
    description: 'Chest-up framing — more of the person than a Face Pendant, less than a full portrait.',
  ...
  couple: {
    ...
    description: 'Wider framing to keep two people comfortably in frame.',
  ...
  family: {
    ...
    description: 'The widest framing, for a group of three or more.',
  ...
  pet: {
    id: 'pet',
    label: 'Pet Pendant',
    description: 'A close crop tuned for a single pet\'s head and shoulders.',
  ...
  heart: {
    id: 'heart',
    label: 'Heart Pendant',
    description: 'Standard portrait framing for the classic heart-shaped product line.',
  ...
  round: {
    id: 'round',
    label: 'Round Pendant',
    description: 'Standard portrait framing for the round product line.',
  ...
  oval: {
    id: 'oval',
    label: 'Oval Pendant',
    description: 'Standard portrait framing for the oval product line.',
