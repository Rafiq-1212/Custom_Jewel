...
FACES TAKE MUCH LESS HATCHING THAN CLOTHES OR HAIR. On the skin of a face and neck, hatch only the deepest shadows — under the nose and chin, inside the eye sockets, and the side of the face turned away from the light — with a few fine, widely spaced lines. Leave the forehead, the cheeks and the rest of the skin clean and white. The face should read by its contours and features, not by shading.
HAIR IS EXACTLY THE HAIR IN IMAGE 1. Its outline, its height and its volume stay exactly where the pencils put them. Each person's hair keeps its own kind, judged separately for each person: tight messy curls stay tight messy curls, drawn as small curls; straight, smooth or oiled hair stays straight and smooth, drawn as smooth strands — never give curls to anyone whose hair is not curly in image 2; hair tied back, plaited or in a bun stays tied back exactly as image 1 shows it and is never let down or lengthened; short hair stays short; flat hair stays flat. Never comb, style, smooth, lift or thicken it, and never turn curls into waves or a neat illustration hairstyle. Draw the hair this person actually has, not a better haircut.
