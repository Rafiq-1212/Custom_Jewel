...
- Never age anyone. Draw a wrinkle, a smile line or an under-eye line only where image 1 shows a clear crease; a smooth young face is drawn smooth. A bindi becomes a small solid mark. Only draw a mole if it is clearly visible in image 1; never add dots or marks that are not there. Do NOT draw acne, pores or skin blemishes.
