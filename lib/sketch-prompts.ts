...
- A fine dotted, speckled or micro-check print (a shirt covered in tiny dots) is NOT drawn dot by dot: suggest it in a couple of places and leave the rest of that garment plain, so the engraver is not asked to burn thousands of specks.
